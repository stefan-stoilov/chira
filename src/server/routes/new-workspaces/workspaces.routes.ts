...
export const updateWorkspaceRoute = createRoute({
  ...
  responses: {
    [http.OK]: jsonContent(createSuccessSchema(), "Update Workspace"),
    [http.UNAUTHORIZED]: jsonContent(
      createErrorMessageSchema(),
      "Unauthorized",
    ),
...
export const deleteWorkspaceRoute = createRoute({
  ...
  responses: {
    [http.OK]: jsonContent(createSuccessSchema(), "Delete Workspace"),
    [http.UNAUTHORIZED]: jsonContent(
      createErrorMessageSchema(),
      "Unauthorized",
    ),
